...
{
    /// <summary>
    /// Interaction logic for TSAbout.xaml
    /// </summary>
    public partial class TSAbout : Window
    {
        /// <summary>
        ...
        /// <summary>
        /// Constructor that takes a parent for this TSAbout dialog.
        /// </summary>
        /// <param name="parent">Parent window for this dialog.</param>
        public TSAbout(Window parent)
            : this()
        {
            this.Owner = parent;
        }
